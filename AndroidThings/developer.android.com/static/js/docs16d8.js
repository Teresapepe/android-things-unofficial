...
if (customSearchEnabled == 'undefined' || customSearchEnabled == null) {
...
function initReferenceSelector() {
  $("#reference-selector").change(function() {
    ...
    var value = $(this).val();
    var path = '/reference/'.concat(value + '/package-summary.html');
...
(function($) {
  ...
  function renderResults(el, results, searchAppliance) {
    ...
    if (results == 'disabled') {
      el.append($('<div class="dac-search-search-status">').text(
          devsite.searchVars.MSG_CUSTOM_SEARCH_UNAVAILABLE));
      return;
    } else {
      if (!results.items) {
        el.append($('<div class="dac-search-search-status">').text(
  ...
  $.fn.customSearch = function(query, searchAppliance) {
    ...
    if (customSearchEnabled) {
      ...
      el.empty();
      renderResults(el, 'disabled', searchAppliance);
    }
  };
...
(function($, metadata) {
  ...
  Search.prototype.getUrlQuery = function() {
    if (devsite.permissions.hasPermission('CSE_2')) {
